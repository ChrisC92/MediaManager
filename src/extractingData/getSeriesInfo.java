...
public class getSeriesInfo {
     ...
     * into that object
     */
    public static List<Series> getSeriesInfo(File filePath) throws NullPointerException {
        ...
        for (File fileEntry : filePath.listFiles()) {
            if (fileEntry.isDirectory()) {
                 ...
                 */
                if (isSeriesInlcuded(seriesName, seriesList)) {
    ...
    private static boolean isSeriesInlcuded(String seriesName, List<Series> seriesList) {
